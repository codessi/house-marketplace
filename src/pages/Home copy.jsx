...
export default function Home() {
  return (
    <div>
      <div className='h-[80vh] overflow-hidden outline-1 relative flex justify-center items-center'>
        <img className='w-full h-full  object-cover object-center absolute top-0  left-0 -z-10'  src={home} alt="" />
        <div className='w-full h-full bg-gray-900/20 absolute top-0 left-0 -z-10'></div>
        <div className='relative mt-12 h-40 w-3/4  md:w-1/2'>
          <h3 className="text-white text-5xl font-serif text-center">Find your place</h3>
          <form action="">
